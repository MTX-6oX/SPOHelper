 ...
 */
public class TestSPOnlineMin {

	private static final String USERNAME="intrasync@zungfu.com";
	private static final String DOMAIN="zfhk";
	//private static final String USERNAME="intrasync@zungfu.com";
	...
	public void test1() {
		try {
			...
			if (token != null) { //LOGIN
				...
				System.out.println(SPOnline.prettyFormatJson(data.toString()));
...
//			Logger.getLogger(TestSPOnline.class.getName()).log(Level.SEVERE, null, ex);
			...
			Logger.getLogger(TestSPOnlineMin.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
